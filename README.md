...
- **Validation** — Pluggable `ITableValidator` interface to mark cells as invalid; invalid cells receive error styling and show messages on hover. `ValidationChanged` reports the current error map after every validation pass.
